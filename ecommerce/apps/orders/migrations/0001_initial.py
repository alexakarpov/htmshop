# Generated by Django 4.2.2 on 2023-07-23 07:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('INCENSE', 'incense'), ('ENL_OR_RED', 'enlargement or reduction'), ('GENERIC', 'generic')], default='GENERIC', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory.productstock')),
            ],
        ),
        migrations.CreateModel(
