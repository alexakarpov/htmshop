...
class AccountTest(TestCase):
    ...
    def test_fixture_worked(self):
        self.assertEqual(Account.objects.all().count(),
                          3,
    ...
    def test_address_from_json(self):
        ...
        self.assertEqual(address.customer, acc)
        self.assertEqual(j_dict["full_name"], "Foo Bar",
                          "wrong name on the address")
        self.assertEqual(j_dict["city_locality"], "Seattle")
